    ...
    <li>
      <div className="reviews">
        <div className="flex items-center mb-4 space-x-4">
          <img className="w-10 h-10 rounded-full" src="https://img.freepik.com/premium-vector/female-user-profile-avatar-is-woman-character-screen-saver-with-emotions_505620-617.jpg" alt="" />
        ...
        <p className="mb-2 font-light text-gray-500 dark:text-gray-400">{props.review}</p>
